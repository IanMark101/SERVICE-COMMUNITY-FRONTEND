      ...
      <div className="relative w-full max-w-lg px-4 z-10">
        ...
        <div className={`rounded-[2rem] shadow-2xl border-2 px-8 py-6 relative ${
          ...
          <div className="text-center mb-4">
            <h1 className={`text-2xl font-black ${isDark ? 'text-white' : 'text-[#3d3f56]'}`}>Reset Password</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className={`block text-sm font-black mb-2 ${isDark ? 'text-white' : 'text-[#3d3f56]'}`}>New Password</label>
              <input
                type="password"
                value={password}
            ...
            <div>
              <label className={`block text-sm font-black mb-2 ${isDark ? 'text-white' : 'text-[#3d3f56]'}`}>Confirm Password</label>
              <input
                type="password"
