    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f5f6fb] to-white">
      ...
      <div className="px-4 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Header Card - REMOVE SEARCH BAR FROM HERE */}
            ...
            <div className="flex border-b-4 border-gray-200">
              {(["info", "offers", "requests", "ratings"] as Tab[]).map((tab) => (
                ...
                >
                  ...
                  {tab === "offers" && (
                    <>
                      <Briefcase className="w-6 h-6" /> My Offers
                    </>
                  )}
                  {tab === "requests" && (
                    <>
              ...
              {activeTab === "offers" && (
                <div className="space-y-8">
                  {offersLoading ? (
                          ...
                          >
                            ...
                            <div className="flex gap-3">
                              <button
                                ...
                                className="flex-1 bg-[#1CC4B6] hover:bg-[#19b0a3] text-white font-black py-2 px-4 rounded-full text-base transition-all"
                              >
                                Edit
                              </button>
                              <button
                                onClick={() => handleDeleteOffer(offer.id)}
                                className="flex-1 bg-red-500 hover:bg-red-600 text-white font-black py-2 px-4 rounded-full text-base transition-all"
                              >
                                Delete
                              </button>
                            </div>
                        ...
                        {offersTotalPages > 1 && (
                          <div className="flex justify-center gap-4 mt-8">
                            <button
                              ...
                              className="px-6 py-3 bg-gray-200 hover:bg-gray-300 disabled:opacity-50 rounded-full font-black text-lg"
                            >
                              Previous
                            </button>
                            <span className="px-6 py-3 font-black text-lg">
                    ...
                    <p className="text-center text-gray-500 py-12 text-xl">No offers yet</p>
                  )}
                </div>
              )}
              ...
              {activeTab === "requests" && (
                <div className="space-y-8">
                  {requestsLoading ? (
                          ...
                          >
                            ...
                            <div className="flex gap-3">
                              <button
                                ...
                                className="flex-1 bg-[#1CC4B6] hover:bg-[#19b0a3] text-white font-black py-3 px-4 rounded-full transition-all text-lg"
                              >
                                Edit
                              </button>
                              <button
                                onClick={() => handleDeleteRequest(request.id)}
                                className="flex-1 bg-red-500 hover:bg-red-600 text-white font-black py-3 px-4 rounded-full transition-all text-lg"
                              >
                                Delete
                              </button>
                            </div>
                    ...
                    <p className="text-center text-gray-500 py-12 text-xl">No requests yet</p>
                  )}
                </div>
              )}
        ...
        {editingOffer && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl">
              <h2 className="text-3xl font-black text-[#3d3f56] mb-6">Edit Offer</h2>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border-2 border-gray-300 rounded-xl font-semibold focus:outline-none focus:border-[#1CC4B6] text-gray-900"
                  />
                </div>
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  ...
                  className="flex-1 bg-[#1CC4B6] hover:bg-[#19b0a3] text-white font-bold py-3 rounded-full transition-all"
                >
                  Save
                </button>
              </div>
        ...
        {editingRequest && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl">
              <h2 className="text-3xl font-black text-[#3d3f56] mb-6">Edit Request</h2>
